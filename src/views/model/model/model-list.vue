  ...
  <div v-loading="loading">
    ...
    <el-form :inline="true" :model="page" class="demo-form-inline" size="mini">
      <el-form-item label="模糊查询">
        <el-input v-model="page.params.modelName" placeholder="modelName" clearable />
      </el-form-item>
      <el-form-item label="起始日期">
        <el-date-picker
          v-model="page.params.modelTime"
          type="daterange"
          align="right"
          unlink-panels
          range-separator="至"
    ...
    >
      ...
      <el-table-column label="操作" width="360" align="center">
        <template slot-scope="scope">
          <el-button size="mini" type="primary" @click="toUpdate(scope.row.modelId)">修改</el-button>
          <el-button size="mini" type="info" @click="toRead(scope.row.modelId)">查看</el-button>
    ...
    <el-dialog title="添加" :visible.sync="addDialog">
      <model-add @closeAddDialog="closeAddDialog" @getByPage="getByPage" />
    </el-dialog>
    <!--
      修改弹窗
...
export default {
  ...
  methods: {
    ...
    getByPage() {
      modelApi.getByPage(this.page).then(res => {
        this.page = res.data
        this.loading = false
        console.log(res)
      })
    ...
    refresh() {
      ...
      this.page.params.modelName = null
      this.page.params.modelTime = null
