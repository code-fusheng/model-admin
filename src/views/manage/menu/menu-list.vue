  ...
  <div v-loading="loading">
    ...
    <el-form :inline="true" :model="page" class="demo-form-inline" size="mini">
      <el-form-item label="模糊查询">
        <el-input v-model="page.params.name" placeholder="name" clearable />
      </el-form-item>
      <el-form-item label="权限级别">
        <el-select v-model="page.params.level" placeholder="level" clearable filterable>
